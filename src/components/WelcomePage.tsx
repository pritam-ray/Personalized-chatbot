        ...
        <div className="grid sm:grid-cols-2 gap-4 mt-12">
          {suggestions.map((suggestion, index) => (
            <button
              key={index}
              onClick={onNewChat}
              className="group p-6 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-panel)] hover:bg-[var(--bg-control-hover)] hover:border-[var(--accent)] transition-all text-left"
            >
